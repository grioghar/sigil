...
| **1.x** | A dependency-free distribution: Z3 statically linked, and (the open question — see SELFHOST.md) codegen emitted directly rather than via rustc. Plus `?`-style error propagation, a shared standard library, and `Float`. | |
